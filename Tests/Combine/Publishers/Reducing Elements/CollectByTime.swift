...
/*
 С момента публикации первого значения включаются счетчик времени и счетчик
 размера массива значений. Если массив не успевает заполниться до требуемого
 размера до окончания временного интервала, то опубликуется текущий массив.
 */
