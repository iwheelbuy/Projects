 ...
 */
final class ContainsWhere: XCTestCase {
   ...
   func test_common_behavior() {
      for index in [0, 1] {
         ...
         switch index {
         case 0:
            let publisher = Publishers.ContainsWhere(upstream: upstream, predicate: { $0 == "b" })
         ...
         case 1:
            let publisher = Publishers.ContainsWhere(upstream: upstream, predicate: { $0 == "c" })
